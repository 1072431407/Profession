...
public class ConstantFactory implements IConstantFactory {
    ...
    @Override
    public String getApplayStatus(Integer status) {
        return ApplayStatus.valueOf(status);
    }
	...
	public String getJobTypeName(Integer jobType) {
		...
		return getDictsByName("职位类型", jobType);
	}

	@Override
	public String getApplyStatusName(Integer status) {
		return getDictsByName("状态", status);
	}
